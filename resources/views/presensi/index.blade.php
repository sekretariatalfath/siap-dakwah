...
<div class="max-w-7xl mx-auto font-inter">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <form action="{{ route('presensi.generate') }}" method="POST" class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                @csrf
        ...
        <div class="lg:col-span-1 space-y-4">
            {{-- SEARCH BAR --}}
            <form action="{{ route('presensi.index') }}" method="GET" class="relative group">
