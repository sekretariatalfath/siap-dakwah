...
<div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div class="flex items-center gap-4">
        <a href="{{ route('dashboard') }}" class="p-3 bg-white rounded-2xl shadow-sm border border-gray-100 text-gray-400 hover:text-gray-900 transition transform hover:-translate-x-1">
                ...
                @forelse($resources as $item)
                    ...
                    <tr class="hover:bg-gray-50/50 transition group">
                        ...
                        <td class="px-8 py-6">
                            ...
                            @else
                                <span class="bg-gray-50 text-gray-400 px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider border border-gray-100">Internal</span>
                            @endif
                        </td>
                        <td class="px-8 py-6 flex justify-end gap-3 items-center">
                            ...
                            <form action="{{ route('resource.delete', $item->row_index) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                ...
                                <button type="submit" class="p-2 text-gray-400 hover:{{ $theme['text'] }} transition hover:{{ $theme['light'] }} rounded-xl">
                    ...
                    <tr>
                        <td colspan="4" class="px-8 py-32">
                            <div class="flex flex-col items-center justify-center w-full">
                                ...
                                <p class="text-gray-400 italic text-sm font-bold uppercase tracking-widest">Belum ada data tersedia di kategori ini.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
...
<div id="modalAdd" class="fixed inset-0 bg-black/60 hidden flex items-center justify-center p-4 z-50 backdrop-blur-sm">
    <div class="bg-white rounded-[40px] p-8 md:p-10 w-full max-w-lg shadow-2xl relative animate-in fade-in zoom-in duration-300">
        <button onclick="document.getElementById('modalAdd').classList.add('hidden')" class="absolute top-6 right-6 text-gray-400 hover:text-gray-900 transition">
        ...
        <p class="text-xs text-gray-400 mb-8 font-medium italic">Data otomatis masuk ke tab Spreadsheet terkait.</p>
        ...
        <form action="{{ route('resource.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-widest">Judul Berkas</label>
            ...
            <div>
                <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-widest">Keterangan Singkat</label>
            ...
            <div>
                <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-widest">Tautan (Link) Akses Google Drive</label>
            ...
            <div>
                <label class="text-[10px] font-bold text-gray-400 uppercase ml-2 tracking-widest">Status Akses Berkas</label>
