    ...
    <div class="bg-white w-full max-w-lg rounded-[32px] shadow-2xl overflow-hidden border border-white/20 animate-zoom-in my-auto">
        ...
        <div class="bg-gray-900 px-8 py-10 text-white relative">
            ...
            <div class="relative z-10 flex justify-between items-start">
                <div class="space-y-2">
                    ...
                    <p id="pre_id" class="text-[10px] font-mono text-gray-400 uppercase tracking-widest"></p>
                </div>
        ...
        <div class="p-8 space-y-8 max-h-[60vh] overflow-y-auto custom-scrollbar">
            ...
            <div class="grid grid-cols-2 gap-x-8 gap-y-6">
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Kategori Program</label>
                    <p id="pre_kategori" class="text-xs font-black text-gray-800"></p>
                </div>
                
                {{-- INFO BARU: BENTUK KEGIATAN --}}
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Bentuk Kegiatan</label>
                ...
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Anggaran Diajukan</label>
                    <p id="pre_anggaran" class="text-xs font-black text-red-700 font-mono"></p>
                </div>
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Lokasi / Tempat</label>
                    <p id="pre_tempat" class="text-xs font-black text-gray-800 uppercase"></p>
                </div>
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Target Peserta</label>
                    <p id="pre_peserta" class="text-xs font-black text-gray-800"></p>
                </div>
                <div>
                    <label class="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Jumlah Panitia</label>
            ...
            {{-- SEPARATOR KONTAK --}}
            <div class="space-y-4">
                <p class="text-[9px] font-black text-gray-400 uppercase tracking-[0.3em] text-center">Penanggung Jawab (CP)</p>
                <div class="bg-red-50/30 rounded-3xl p-5 border border-red-50 space-y-3">
                    <div class="flex justify-between items-center border-b border-red-100/50 pb-2">
                        <span class="text-[10px] font-bold text-gray-400 uppercase">Nama / NIM</span>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-[10px] font-bold text-gray-400 uppercase">ID Line</span>
