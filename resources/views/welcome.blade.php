    ...
    <header class="relative pt-12 md:pt-16 pb-20 md:pb-24 overflow-hidden w-full">
        <div class="container mx-auto px-4 md:px-6 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-4 md:gap-6 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-300">
                <a href="{{ route('public.template') }}" class="px-6 md:px-8 py-3 md:py-4 bg-red-700 text-white font-black rounded-xl md:rounded-2xl shadow-xl shadow-red-200 hover:bg-red-800 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3 tracking-wide text-[11px] md:text-base">
                ...
                <a href="{{ route('public.sop') }}" class="px-6 md:px-8 py-3 md:py-4 bg-white text-gray-700 font-black rounded-xl md:rounded-2xl shadow-sm border border-gray-200 hover:border-red-600 hover:text-red-700 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3 tracking-wide text-[11px] md:text-base">
