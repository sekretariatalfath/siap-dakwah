...
<div class="min-h-screen bg-gray-50/30 font-inter selection:bg-red-100 selection:text-red-700">
    ...
    <main class="container mx-auto px-6 py-12 -mt-16 relative z-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="templateGrid">
            ...
            <div class="template-card bg-white p-8 rounded-[40px] border border-gray-100 hover:border-red-200 hover:shadow-2xl hover:shadow-red-100/20 transition-all duration-500 group flex flex-col justify-between transform hover:-translate-y-2">
                <div>
