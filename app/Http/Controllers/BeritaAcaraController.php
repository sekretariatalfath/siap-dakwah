    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $replacements = [
                ...
                '[tempat pelaksanaan]' => $request->tempat, 
                ...
                'NIM. XXXXXXX' => 'NIM. ' . $request->nim_ketua, 
                '[NAMA_SEKRETARIS]' => $request->nama_sekretaris,
                'NIM. [XXXXXXX]' => 'NIM. ' . $request->nim_sekretaris, 
                '[NAMA_KOORDINATOR]' => $request->nama_koordinator ?? '.........................',
                '(NIM. XXXXXXX)' => isset($request->nim_koordinator) ? 'NIM. ' . $request->nim_koordinator : '.........................',
                '[JABATAN_KOORDINATOR]' => $jabatanKoordinator,
            ];
